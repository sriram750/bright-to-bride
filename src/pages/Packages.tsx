  ...
  return (
    <div className="bg-studio-cream pt-28 text-studio-charcoal min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-6 mt-4">
        <ScrollReveal className="bg-studio-sand/30 border border-studio-gold/20 p-6 text-center rounded">
          ...
          {packagesData.map((pkg) => (
            <StaggerItem key={pkg.id}>
              <motion.div
                ...
                className={`border p-8 rounded flex flex-col justify-between relative h-full transition-luxury ${
                  pkg.recommended
                    ? 'bg-studio-sand/40 border-studio-gold shadow-md scale-102 lg:scale-105 z-10'
                    : 'bg-studio-cream border-studio-gold/15 shadow-xs'
                }`}
              >
                {pkg.recommended && (
                  <span className="absolute top-0 right-8 -translate-y-1/2 bg-studio-gold text-studio-charcoal text-[9px] tracking-widest uppercase font-bold px-3 py-1 rounded-full shadow-sm">
                    Most Popular
                  </span>
                )}
                ...
                <div className="space-y-3 mt-4">
                  <motion.button
                    ...
                    className="w-full text-center py-3.5 bg-studio-charcoal text-studio-cream hover:bg-studio-gold hover:text-studio-charcoal font-sans text-[10px] tracking-widest uppercase transition-colors duration-300 font-semibold shadow-sm"
                  >
                  ...
                  <motion.a
                    ...
                    className="w-full text-center py-3.5 border border-emerald-600/30 text-emerald-700 hover:bg-emerald-600 hover:text-white font-sans text-[10px] tracking-widest uppercase transition-colors duration-300 font-semibold flex items-center justify-center"
                  >
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 border-t border-studio-gold/15">
        <ScrollReveal>
          ...
          <GoldLineDraw width={120} />
          
          <div className="overflow-x-auto shadow-sm border border-studio-gold/10 mt-8">
