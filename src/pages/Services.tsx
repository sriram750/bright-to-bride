    ...
    <div className="bg-studio-cream pt-28 text-studio-charcoal">
      ...
      <section className="py-20 max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          {childhoodServices.map((service) => (
            ...
            >
              <div>
                <div className="relative aspect-[16/10] overflow-hidden mb-6 rounded border border-studio-gold/10">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  />
                  <div className="absolute top-4 left-4 bg-studio-charcoal/80 backdrop-blur-sm text-studio-gold font-serif text-[11px] px-3 py-1 rounded">
                    {service.tamilTitle}
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 border-t border-studio-gold/10 pt-6 mt-4">
                <button
                  ...
                  className="bg-studio-charcoal hover:bg-studio-gold text-studio-cream hover:text-studio-charcoal text-center py-3 font-sans text-[10px] tracking-widest uppercase transition-all duration-300 font-semibold flex items-center justify-center"
                >
                ...
                <a
                  ...
                  className="border border-emerald-600/30 text-emerald-700 hover:bg-emerald-600 hover:text-white text-center py-3 font-sans text-[10px] tracking-widest uppercase transition-all duration-300 font-semibold flex items-center justify-center"
                >
            ...
            {weddingServices.map((service) => (
              ...
              >
                <div>
                  <div className="relative aspect-[16/10] overflow-hidden mb-6 rounded border border-studio-gold/10">
                    <img
                      ...
                      className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                    />
                    <div className="absolute top-4 left-4 bg-studio-charcoal/80 backdrop-blur-sm text-studio-gold font-serif text-[10px] px-2.5 py-1 rounded">
                      {service.tamilTitle}
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4 border-t border-studio-gold/10 pt-6 mt-4">
                  <button
                    onClick={() => handleBookClick(service.title)}
                    className="bg-studio-charcoal hover:bg-studio-gold text-studio-cream hover:text-studio-charcoal text-center py-2.5 font-sans text-[9px] tracking-widest uppercase transition-all duration-300 font-semibold flex items-center justify-center"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="border border-emerald-600/30 text-emerald-700 hover:bg-emerald-600 hover:text-white text-center py-2.5 font-sans text-[9px] tracking-widest uppercase transition-all duration-300 font-semibold flex items-center justify-center"
                  >
      ...
      <section className="py-24 text-center max-w-4xl mx-auto px-6">
        ...
        <button
          ...
          className="inline-block bg-studio-charcoal text-studio-cream hover:bg-studio-gold hover:text-studio-charcoal px-8 py-3.5 font-sans text-xs tracking-widest uppercase transition-all duration-300 font-semibold"
        >
          Explore Packages
        </button>
      </section>
